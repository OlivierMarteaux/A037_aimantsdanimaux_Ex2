    ...
    floatingActionButton = {
      Row(
        ...
        ExtendedFloatingActionButton(
          onClick = { onEditClick(animal); Log.v("OM_TAG", "Edit animal: $animal") },
        ...
        ExtendedFloatingActionButton(
          onClick = {
            ...
            onBackClick()
            Log.v("OM_TAG","${animal?.name} has been remove from the list.")
            Log.v("OM_TAG","New animals list:")
            AnimalData.animals.forEach {
              Log.v("OM_TAG"," - ${ it.name }")
            }
          },
